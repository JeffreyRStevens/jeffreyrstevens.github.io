...
:::
 ...
 | 
-- | --
{{< fa envelope title="An envelope" >}} [jeffrey.r.stevens@protonmail.com](mailto:jeffrey.r.stevens@protonmail.com) |  [Open Science Framework](https://osf.io/4nx8b/)
...
[2019-2023]{.aside} Guest speaker at Edgerton Explorit Dog Science Camp
...
Developer of R package [formatstats](https://jeffreyrstevens.github.io/formatstats/), which format statistical output in a way that can be inserted into R Markdown documents.
