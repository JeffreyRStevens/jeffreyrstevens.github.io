...
![Source: UNL CCHIL](images/dog_number_study_wide.jpg){fig-align="center" fig-alt="Close-up view of black and white Boston terrier eating training treats from a plate."}

We recently published a [paper](../../pubs/deboer_etal_2025.pdf) in _Psychological Topics_ that describes our most recent study conducted at the Canine Cognition and Human Interaction Lab (CCHIL). Undergraduates Hunter DeBoer and Hannah Fitzpatrick led this project under the supervision of graduate students Anwyn Gatesy-Davis and London Wolff. This work was conducted in collaboration with [Uplifting Paws](https://www.upliftingpaws.org/).
...
![Source: [Mathew Coulton](https://unsplash.com/photos/brown-peanuts-in-blue-plastic-bowl-zxqaAkkayP8)](images//mathew-coulton-zxqaAkkayP8-unsplash.jpg){fig-align="center" fig-alt="Overhead view of a bowl of kibble with a few piles of kibble on the floor, along with two white dog paws sticking into the frame."}

Animal researchers have investigated how many different species quantify lots of different things in their environments. An important question that they've asked is _how_ animals compare quantities. 
...
![Can you tell which side (a or b) has more dots in both the top and bottom panels? Answer at the bottom.](images/weber.png){fig-align="center" fig-alt="Top left: Cluster of 25 dogs. Top right: Cluster of 24 dots. Bottom left: Cluster of 50 dogs. Botton right: Cluster of 48 dots."}
...
We were interested in whether ratio, difference, or both influenced dog's ability to quantify objects. To test this, we conducted a _quantity preference task_ where we presented subjects with two quantities of treats and let them pick and eat one of the two quantities.

![We offered dogs plates with different quantities of treats on them. Dogs could only eat the first quantity that they picked.](images/preference_stim.jpg){fig-align="center" fig-alt="Overhead view of two plates of treats with two treats on the left plate and four treats on the right plate."}
...
![Dogs chose the larger quantities more as difference increased and ratio decreased.](images/hypothesis1.1.png){fig-align="center" fig-alt="Two-panel figure showing mean percent choice for larger quantity as a function of numerical difference (left panel) and numerical ratio (right panel). Figure shows individual dog responses as lines and mean and 95% confidence intervals as dogs and error bars. Mean choice increases with difference and decreases with ratio."}

However, ratio and difference are _confounded_, which means that they are not completely independent. As you change one, you will also change the other. This suggests that we need to do some additional analyses to disentangle whether ratio affects quantity preference _independent of difference_ and whether difference affects quantity preference _independent of ratio_. After running this analysis, we found that **only difference predicted quantity preferences** when ratio was held constant.

![Within ratios, we still see difference influencing quantity preferences. But within differences, we do not see ratios influencing quantity preferences.](images/ratio_diff.png){fig-align="center" fig-alt="Three-panel figure showing mean percent choice for larger quantity as a function of numerical difference with each panel representing one ratio: 0.33, 0.50, and 0.67. Figure shows individual dog responses as lines and mean and 95% confidence intervals as dogs and error bars. Mean choice increases with difference in all three panels."}

## What does this mean?

When we hold difference constant, ratio does not predict quantity preference. However, when we hold ratio constant, difference _does_ predict quantity preference. So, we found that **difference does a better job than ratio of accounting for quantification in dogs**. 
