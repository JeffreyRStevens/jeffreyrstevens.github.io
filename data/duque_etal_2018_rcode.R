###################################################
### Juan F. Duque (jfduque89@gmail.com) & Jeffrey R. Stevens (jeffrey.r.stevens@gmail.com)
###	finalized on 2018-04-11
### Summary: This script takes our data and extracts the relevant information 
###   needed to run analyses script, "duque_etal_2018_rcode.R"
### Citation:
###   Duque, J. F., Leichner, W., Ahmann, H., & Stevens, J. R. (2018). 
###   Mesotocin influences pinyon jay prosociality. 
###   Biology Letters, 14(4), 20180105. https://doi.org/10.1098/rsbl.2018.0105
### Instructions: First, download this script, "duque_etal_2018_rcode.R".  
###   Second, make a folder labeled "figures". 
###   Download the "duque_etal_2018_data.csv" data file into 
###   the home directory and set the working directory to where the scripts are. 
###   At the R command prompt, type source('duque_etal_2018_rcode.R').  This will run the 
###   script and output analyses and figures relevant for Duque et al "Mesotocin influences pinyon jay prosociality". 
###  **********
### Description of the relevant columns for "duque_etal_2018_data.csv":
###
...
###  hormone - hormone condition: NA for Experiment 1; A, B, C, or SAL for Experiment 2
...
all_data <- read_csv("duque_etal_2018_data.csv") %>%   # read in data
